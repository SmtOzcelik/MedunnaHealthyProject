...
public class MedunnaStepDefinition_US018 {
    ...
    public void admin_can_edit_the_date_of_a_physician() {
        ...
        actions.sendKeys("2000").sendKeys(Keys.TAB).sendKeys("11").sendKeys(Keys.TAB).sendKeys("10").perform();
        ReusableMethods.waitFor(1);
        /*
    ...
    public void admin_can_edit_the_phone_number_of_a_physician() {
        ...
        physician.phone.sendKeys("566-566-5666");
        ReusableMethods.waitFor(1);
    ...
    public void admin_can_choose_gender_of_a_physician() {
        ...
        physician.gender.sendKeys(genderOpt.get(0).getText());
    ...
    public void admin_can_choose_blood_group_of_a_physician() {
        ...
        physician.bloodGroup.sendKeys(bloodOpt.get(0).getText());
    ...
    public void admin_can_choose_a_user() {
        ...
        physician.physicianUser.sendKeys(userOpt.get(1).getText());
        actions.sendKeys(Keys.TAB).perform();
        ReusableMethods.waitFor(1);
    ...
    public void admin_can_choose_a_country() {
        ...
        physician.country.sendKeys(countryOpt.get(26).getText());
        ReusableMethods.waitFor(1);
        /*
    ...
    public void admin_can_choose_a_state() {
        ...
        physician.state.sendKeys(stateOpt.get(2).getText());
        ReusableMethods.waitFor(1);
    ...
    public void adminCanChooseASpecialityOfAPhysician() {
        ...
        physician.speciality.sendKeys(specialityOpt.get(0).getText());
    ...
    public void adminCanChangeAPhotoOfAPhysician() {
        js.executeScript("arguments[0].scrollIntoView(true);", physician.profilPhoto);
        physician.profilPhoto.sendKeys("C:\\Users\\PC\\OneDrive\\Masaüstü\\Proje Medunna Proje\\resim.jpg");
        js.executeScript("arguments[0].click();", physician.saveButton);
    }
    ...
    public void adminEntersTheDateOfAPhysician() {
        physician.birthday.click();
        actions.sendKeys("2000").sendKeys(Keys.TAB).sendKeys("11").sendKeys(Keys.TAB).sendKeys("28").perform();
        ReusableMethods.waitFor(1);
    ...
    public void adminNavigatesTheSignInPage() {
        physician.signInDropDown.click();
    }

    @And("Admin signs in")
    public void adminSignsIn() {
        physician.signInButton.click();
        ReusableMethods.waitFor(1);
        physician.username.sendKeys(ConfigReader.getProperty("AdminUserName"));
        physician.password.sendKeys(ConfigReader.getProperty("AdminPassword"));
        ReusableMethods.waitFor(1);
        physician.signInButton2.click();
        ReusableMethods.waitFor(1);
